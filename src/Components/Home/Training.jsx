            ...
            <Paper elevation={2} className="training-item">
              ...
              <div className="box">
                ...
                <Typography className="training-info">
                  Our courses are strategically and innovatively designed,
                  blending both theoretical and practical teaching methods. The
                  modules are carefully chosen to ensure the course is as
                  industry-relevant as possible. The courses are concise yet
            ...
            <Paper elevation={2} className="training-item">
              ...
              <div className="box">
                ...
                <Typography className="training-info">
                  ...
                  try the various programs and courses that we offer through our
                  free demo service. Using this service students can test the
                  course quality and get a better understanding of what course
                  they want to study.
                </Typography>
              </div>
            </Paper>
